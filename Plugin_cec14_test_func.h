...
void cf01 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 1 */
void cf02 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 2 */
void cf03 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 3 */
void cf04 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 4 */
void cf05 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 5 */
void cf06 (double *, double *, int , double *,double *, int, /*MIT*/int TestMode); /* Composition Function 6 */
void cf07 (double *, double *, int , double *,double *, int *, int, /*MIT*/int TestMode); /* Composition Function 7 */
void cf08 (double *, double *, int , double *,double *, int *, int, /*MIT*/int TestMode); /* Composition Function 8 */
...
void cf_cal(double *, double *, int, double *,double *,double *,double *,int, /*MIT*/int TestMode);
